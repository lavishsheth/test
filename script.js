...
function loadAndDisplayData() {
   ...
   "prizes":[
      ...
      },
      {
        ...
        dataContainer.innerHTML = "<h2>Data for All Option</h2><pre>" + JSON.stringify(jsonData, null, 2) + "</pre>";
    } else {
        // Hide the data container if a different option is selected
        dataContainer.style.display = "none";
    }
}

// Add an event listener to the dropdown to trigger data loading/display
var categoryDropdown = document.getElementById("categoryDropdown");
categoryDropdown.addEventListener("change", loadAndDisplayData);
